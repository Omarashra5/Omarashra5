...
💻 I specialize in building full-stack web applications from scratch using modern technologies  
🚀 Completed 35+ real-world projects including scalable web apps and E-commerce platforms  
🛒 Built complete E-commerce systems with authentication, payments, dashboards & APIs  
🌐 Experienced in deploying and optimizing apps using Vercel  
...
- Others: Python (Tkinter), WordPress  
...
![Search Algorithms](https://img.shields.io/badge/search-algorithms-purple)
![Clean Code](https://img.shields.io/badge/clean-code-green)
...
### 📊 Productivity:
![Microsoft Word](https://img.shields.io/badge/word-blue?logo=microsoftword)
![Microsoft Excel](https://img.shields.io/badge/excel-green?logo=microsoftexcel)
![PowerPoint](https://img.shields.io/badge/powerpoint-red?logo=microsoftpowerpoint)
---
